...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	smsOrderService := service.NewSmsOrderService(smsOrderRepository, heroSmsClient, configConfig)
	...
	smsOrderHandler := handler.NewSmsOrderHandler(smsOrderService)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, smsOrderHandler, idempotencyCoordinator, idempotencyCleanupService)
