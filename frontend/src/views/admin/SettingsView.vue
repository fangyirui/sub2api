      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          ...
          <div class="space-y-6 p-6">
            ...
            <!-- SMS Order Copy Template -->
            <div>
              <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                {{ t('admin.settings.site.smsOrderCopyTemplate') }}
              </label>
              <textarea
                v-model="form.sms_order_copy_template"
                rows="4"
                class="input font-mono text-sm"
                :placeholder="t('admin.settings.site.smsOrderCopyTemplatePlaceholder')"
              ></textarea>
              <p class="mt-1.5 text-xs text-gray-500 dark:text-gray-400">
                {{ t('admin.settings.site.smsOrderCopyTemplateHint') }}
              </p>
            </div>
