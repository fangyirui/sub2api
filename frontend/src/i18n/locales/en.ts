export default {
  ...
  admin: {
    ...
    smsOrders: {
      ...
      serviceType: 'Type',
      generate: 'Generate',
      generateSingle: 'Generate 1',
      generateBatch: 'Batch',
      generated: 'Generated {count} order(s)',
      generatedAndCopied: 'Generated and copied to clipboard',
      batchResult: 'Generated {count} Orders',
      copyAll: 'Copy All',
      copied: 'Copied!',
    ...
    settings: {
      ...
      site: {
        ...
        smsServiceTypeTitle: 'SMS Service Types',
        smsServiceTypeClaude: 'Allow users to select Claude',
        smsServiceTypeOpenai: 'Allow users to select OpenAI',
        smsServiceTypeHint: 'When disabled, users cannot select this service type on the SMS query page. Active orders are unaffected.',
        smsServiceTypeClaudeMaxPrice: 'Claude Max Price (USD)',
        smsServiceTypeOpenaiMaxPrice: 'OpenAI Max Price (USD)',
        smsServiceTypeMaxPriceHint: 'Maximum price per number passed to Hero SMS. Leave empty to restore defaults (Claude 0.07 / OpenAI 0.35). Takes effect immediately on save.',
  ...
  smsQuery: {
    ...
    allServicesUnavailable: 'All SMS services are temporarily unavailable, please try again later',
