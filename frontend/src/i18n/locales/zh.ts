export default {
  ...
  admin: {
    ...
    smsOrders: {
      ...
      serviceType: '类型',
      generate: '生成订单',
      generateSingle: '生成 1 个',
      generateBatch: '批量生成',
      generated: '已生成 {count} 个订单',
      generatedAndCopied: '已生成并复制到剪贴板',
      batchResult: '已生成 {count} 个订单',
      copyAll: '全部复制',
      copied: '已复制!',
    ...
    settings: {
      ...
      site: {
        ...
        smsServiceTypeTitle: 'SMS 服务类型',
        smsServiceTypeClaude: '允许用户选择 Claude',
        smsServiceTypeOpenai: '允许用户选择 OpenAI',
        smsServiceTypeHint: '关闭后用户在 SMS 查询页将无法选择该服务类型。已激活订单不受影响。',
        smsServiceTypeClaudeMaxPrice: 'Claude 最大单价（USD）',
        smsServiceTypeOpenaiMaxPrice: 'OpenAI 最大单价（USD）',
        smsServiceTypeMaxPriceHint: '传给 Hero SMS 取号接口的最高单价上限。留空恢复默认（Claude 0.07 / OpenAI 0.35）。保存后立即生效。',
  ...
  smsQuery: {
    ...
    outOfStock: '暂无货源',
    allServicesUnavailable: '暂无可用服务，请稍后再试',
    activateBtn: '确认获取号码',
    activating: '正在获取...',
